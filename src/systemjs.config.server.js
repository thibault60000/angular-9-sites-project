...
(function (global) {
  System.config({
    ...
    map: {
      ...
      "@angular/compiler":
        "npm:@angular/compiler@8.0.0/bundles/compiler.umd.min.js",
      "@angular/platform-browser":
        "npm:@angular/platform-browser@8.0.0/bundles/platform-browser.umd.min.js",
      "@angular/platform-browser-dynamic":
        "npm:@angular/platform-browser-dynamic@8.0.0/bundles/platform-browser-dynamic.umd.min.js",
      "@angular/common/http":
        "npm:@angular/common@8.0.0/bundles/common-http.umd.min.js",
      ...
      "angular-in-memory-web-api":
        "npm:angular-in-memory-web-api@0.8.0/bundles/in-memory-web-api.umd.js",
